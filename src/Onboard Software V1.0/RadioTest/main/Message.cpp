...
msg::message_t Message::buildMessage(msg::AirToGndFlags dataFields, uint8_t recipient, void* data) {
    // Message to be sent
    ...
    if(recipient == config::sysGndStation){
        message.packet.buf = buildGroundstationMessageBuffer(1, data);
    }else{
...
char* Message::buildAircraftMessageBuffer(msg::AirToGndFlags dataFields, void* data){
    ...
    if(bit::readBit(dataFields, msg::airLat)){
    ...
    if(bit::readBit(dataFields, msg::airLon)){
    ...
    if(bit::readBit(dataFields, msg::airYaw)){
    ...
    if(bit::readBit(dataFields, msg::airPitch)){
    ...
    if(bit::readBit(dataFields, msg::airRoll)){
    ...
    if(bit::readBit(dataFields, msg::airSpeed)){
    ...
    if(bit::readBit(dataFields, msg::airAltitude)){
    ...
    if(bit::readBit(dataFields, msg::airPIDYaw)){
    ...
    if(bit::readBit(dataFields, msg::airPIDPitch)){
    ...
    if(bit::readBit(dataFields, msg::airPIDRoll)){
    ...
    if(bit::readBit(dataFields, msg::airDropLat)){
    ...
    if(bit::readBit(dataFields, msg::airDropLon)){
    ...
    if(bit::readBit(dataFields, msg::airRSSI)){
    ...
    if(bit::readBit(dataFields, msg::airErrorCode)){
...
// Welcome to the absolute laziest way of preparing the data buffer for the message protocol
// If the bit for a specific data field is set, copy that data element into the buffer
char* Message::buildGroundstationMessageBuffer(msg::GndToAirFlags dataFields, void* data){
    // Initialize data index to keep track of our position in the buffer
    int dataIndex = 0;
    ...
    if(bit::readBit(dataFields, msg::gndTargetLat)){
    ...
    if(bit::readBit(dataFields, msg::gndTargetLon)){
    ...
    if(bit::readBit(dataFields, msg::gndDropRequest)){
    ...
    if(bit::readBit(dataFields, msg::gndGliders)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor1)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor2)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor3)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor4)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor5)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor6)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor7)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor8)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor9)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor10)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor11)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor12)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor13)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor14)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor15)){
    ...
    if(bit::readBit(dataFields, msg::gndMotor16)){
    ...
    if(bit::readBit(dataFields, msg::gndErrorCode)){
